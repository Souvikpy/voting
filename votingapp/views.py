...
def index(request):
    if request.session.get('username'):
        ...
        return render(request,"miniapp/home.html",context={"username":user})
...
def cast_vote(request):
    ...
    return render(request,"miniapp/cast_vote.html",context={"candidates":candidates,"vote_status":v.is_voted})
...
def register(request):
    ...
    return render(request,'miniapp/register.html',context=d)
...
def user_login(request):
    ...
    return render(request,'miniapp/login.html',context={})